    ...
    if (password !== confirmPassword) {
      ...
      return;
       ...
       if (isEditMode && editingUser) {
         ...
         // Solo agregar role_id si está seleccionado
         if (roleId) {
           updateData.role_id = roleId;
         }
         
         // Solo agregar branch_id si está seleccionado
         if (branchId) {
      ...
      refetch(); // Refrescar la lista
       ...
       console.error("userData enviado:", isEditMode ? { name, last_name: lastName, curp, email, role_id: roleId, branch_id: branchId, biometric: 0 } : { name, last_name: lastName, curp, email, biometric: 0 });
