  ...
  const handleCreateUser = async () => {
    if (password !== confirmPassword) {
      ...
      refetch(); // Refrescar la lista
       ...
       console.error("userData enviado:", isEditMode ? { name, last_name: lastName, curp, email, branch_id: branchId, biometric: 0 } : { name, last_name: lastName, curp, email, biometric: 0 });
