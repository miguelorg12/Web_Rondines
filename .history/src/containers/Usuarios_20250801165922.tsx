  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      refetch();
       ...
       console.error("Error originalStatus:", (error as any)?.originalStatus);
       console.error("Error message:", (error as any)?.error);
  ...
  const handleCreateUser = async () => {
    ...
    const newUser: CreateUser = {
      ...
      refetch(); // Refrescar la lista
       ...
       const errorObj = error as { status?: number; data?: any; originalStatus?: number; error?: string };
       ...
       console.error("userData enviado:", isEditMode ? { name, last_name: lastName, curp, email, role_id: roleId, branch_id: branchId, biometric: 0 } : newUser);
