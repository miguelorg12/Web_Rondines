      ...
      try {
        ...
        if (tokenData.accessToken) {
          ...
          if (tokenData.user) {
            ...
            // Guardar ID de la sucursal asignada si existe
            if (tokenData.user.assignedBranches && tokenData.user.assignedBranches.length > 0) {
              const branchId = tokenData.user.assignedBranches[0].id;
              localStorage.setItem("assigned_branch_id", branchId.toString());
              console.log("✅ AuthCallback: Sucursal asignada guardada:", branchId);
            }
          }
