...
function Sucursales() {
  ...
  const handleOpenModal = (branch?: Branch) => {
    if (branch) {
      ...
      // Usar los IDs de los objetos anidados si existen, o null si son null
      setCompanyId(branch.company?.id || null);
      setUserId(branch.user?.id || null);
  ...
  const handleSaveBranch = async () => {
    ...
    if (!editingBranch && (companyId === null || userId === null)) {
  ...
  return (
    <Paper sx={{ width: "100%", overflow: "hidden", p: 2 }}>
      ...
      <GenericModal
        ...
        disabled={!name.trim() || !address.trim() || (editingBranch ? false : (companyId === null || userId === null)) || companies.length === 0 || users.length === 0 || isLoadingCompanies || isLoadingUsers}
        onErrorClear={() => {
        ...
        >
          <FormControl fullWidth sx={{ flex: 1 }}>
            ...
            >
                ...
                <>
                  <MenuItem value={null}>Seleccionar empresa</MenuItem>
          ...
          <FormControl fullWidth sx={{ flex: 1 }}>
            ...
            >
                ...
                <>
                  <MenuItem value="">Seleccionar manager</MenuItem>
                  {users.map((user) => (
