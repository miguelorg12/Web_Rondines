  ...
  switch (env) {
    case 'development':
      return {
        ...
        oauthUrl: import.meta.env.VITE_OAUTH_URL || 'http://localhost:3343/oauth/v1/token',
        USE_TOKEN: true,
      };
    
    case 'qa':
      return {
        ronditrackApiUrl: import.meta.env.VITE_API_BASE_URL || 'https://apiqa.api.ronditrack.online/api/v1/',
    ...
    default:
      return {
        ronditrackApiUrl: 'https://api-sec-qa.ronditrack.online/api/v1/',
